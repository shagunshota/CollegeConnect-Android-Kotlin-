...
class Student_Adapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserViewHolder {
        ...
        return UserViewHolder(view,deletestudent)
    }
    ...
    class UserViewHolder(itemView: View, private val deletestudent: (String) -> Unit)  : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(student: Student) {
            ...
            deltestudent.setOnClickListener {
               deletestudent(student.uniqueId)
            }
